            ...
            {!enviado ? (
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <div className="flex flex-col items-center justify-center text-center gap-4 h-full animate-fade-in">
                            <CheckCircleIcon size={80} color="#1864ab" weight="fill"/>
                            <h2 className="text-3xl font-bold text-blue-900">Mensagem Enviada!</h2>
                            <p className="text-white">
                                Obrigado pelo contato. <br /> Retornaremos em breve.
                            </p>
                            <button 
                                onClick={() => setEnviado(false)}
                                className="mt-6 text-sm underline text-black hover:text-blue-800">
