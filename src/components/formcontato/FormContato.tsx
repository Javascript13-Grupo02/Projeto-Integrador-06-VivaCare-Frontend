...
function FormContato() {
  ...
  return (
    ...
    // Conteiner externo
    <div className="flex items-center justify-center pb-4 bg-linear-to-br from-white to-[#e7f5ff]">

        <div className="flex flex-col justify-center rounded-2xl bg-gray-200 text-slate-800
            ...
            {!enviado ? (
                    ...
                    <div className="flex flex-col gap-1.5">
                        <div className="flex flex-row items-center gap-0.5"> 
                            <UserIcon size={20} color="#1D293D" weight="bold"  />
                        ...
                        <input type="text"
                                ...
                                name="nome"
                                required
                                className="border-2 rounded-xl py-2 px-4 w-6/10 bg-white  text-slate-800 focus:outline-none" />
                    </div>

                    {/* div de email */}
                    <div className="flex flex-col gap-1.5">
                        <div className="flex flex-row items-end gap-0.5">
                            <AtIcon size={20} color="#1D293D" weight="bold" />
                        ...
                        <input type="email"
                                ...
                                name="email"
                                required
                                className="border-2 rounded-xl py-2 px-4 w-7/10 bg-white text-slate-800 focus:outline-none"/>
                    </div>

                    {/* div de mensagem */}
                    <div className="flex flex-col gap-1.5">
                        <div className="flex flex-row items-end gap-0.5">
                            <EnvelopeSimpleIcon size={20} color="#1D293D" weight="bold" />
                        ...
                        <textarea
                                ...
                                name="mensagem"
                                required
                                className="border-2 border-slate-800 rounded-xl py-2.5 px-4 w-9/10 
                                        field-sizing-content bg-white text-slate-800 resize-none focus:outline-none"
                                        rows={5}/>
                        ...
                        <button type="submit"
                                ...
                                className="flex justify-center items-center leading-1.5 mt-2.5 w-9/10 p-4
                                    rounded-lg  text-white font-bold text-md bg-sky-800 
                                    hover:bg-sky-950 inset-1"
                                >Enviar
                        </button>
                    </div>
                </form>
