    ...
    acessoRapido = (
      <>
        <div className="flex items-center gap-3 mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-2xl font-bold text-slate-950 dark:text-slate-100">
            Bem-vindo, {usuario.nome}!
          </h2>
        </div>

        <div
          className={`grid grid-cols-1 ${podeVerClientes ? "lg:grid-cols-2 max-w-5xl" : "grid-cols-1 max-w-3xl"}  gap-8 w-full `}
        >
          <Link
            to="/apolices"
          ...
          >
            ...
            <div className="p-6 flex flex-col gap-2">
              <span className="text-slate-100 font-bold uppercase tracking-widest text-lg">
                Apólices
              </span>
              <p className="text-slate-100 text-sm leading-relaxed">
                Confira todas as apólices vigentes, gerencie coberturas e
                acompanhe o status de cada contrato de forma rápida e
                centralizada.
              </p>
          ...
          {podeVerClientes && (
            ...
            >
              ...
              <div className="p-6 flex flex-col gap-2">
                <span className="text-slate-100 font-bold uppercase tracking-widest text-lg 0">
                  Clientes
                </span>
                <p className="text-slate-100 text-sm leading-relaxed ">
                  Confira uma lista de todos os clientes cadastrados, acesse
                  seus dados de contato e veja as apólices vinculadas a cada um.
                </p>
                <span className="text-slate-100 text-xs font-semibold uppercase tracking-widest mt-2 hover:underline ">
                  Ver clientes →
                </span>
  ...
  return (
    <>
      <section className="bg-white flex flex-col items-center justify-center pt-8 bg-[url('https://images.unsplash.com/photo-1581579186913-45ac3e6efe93')] bg-cover bg-center relative h-dvh">
        <div className="absolute inset-0 bg-sky-950/50"></div>
        <div className="z-10 flex flex-col items-center justify-center gap-4">
          <h1 className="text-3xl md:text-5xl font-bold text-white text-center  m-2">
            VivaCare
          </h1>
      ...
      <div className="min-h-screen flex flex-col items-center py-16 px-4 bg-listras-claras transition-colors duration-300">
